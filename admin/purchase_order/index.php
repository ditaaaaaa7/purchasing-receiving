        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        <?php 
                        $i = 1;
                        $qry = $conn->query("SELECT p.*, s.name as supplier FROM `purchase_order_list` p inner join supplier_list s on p.supplier_id = s.id WHERE p.status='Process' order by p.`date_created` desc");
                        ...
                        ?>
                            <tr class="text-center">
                                ...
                                <td align="center">
                                    <div class="card-body">
                                    <a type="button" class="btn btn-warning btn-md" href="<?php echo base_url.'admin?page=receiving/manage_receiving&po_id='.$row['id'] ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-clock" data-toggle="tooltip" data-placement="top" title="Partially Receive"></span> 
                                    </a>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Report Purchase Order Details - Print View")
