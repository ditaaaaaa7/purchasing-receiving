            ...
            <fieldset class="w-100">
                <div class="col-12">
                    ...
                    <dl>
                        ...
                        <dt class="text-danger">Unit:</dt>
                        <dd class="pl-3"><?php echo isset($unit) ? $unit : '' ?></dd>
                        <dt class="text-danger">Cost:</dt>
                        <dd class="pl-3"><?php echo isset($cost) ? number_format($cost,2) : '' ?></dd>
                        <dt class="text-danger">Supplier:</dt>
...
<div class="form-group">
    <div class="col-12">
        <div class="d-flex justify-content-end align-items-center">
            <button class="btn btn-secondary btn-md" type="button" id="cancel" data-dismiss="modal">Close</button>
        </div>
    </div>
</div>
