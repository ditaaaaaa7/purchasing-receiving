...
<div class="row">
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            <span class="info-box-icon bg-gray elevation-1"><i class="fas fa-file"></i></span>

            <div class="info-box-content">
            <span class="info-box-text">PR Records</span>
            <span class="info-box-number text-right">
                <?php 
                    echo $conn->query("SELECT * FROM `purchase_order_list` WHERE `status` = 'Pending'")->num_rows;
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            <span class="info-box-icon bg-green elevation-1"><i class="fas fa-th-list"></i></span>

            <div class="info-box-content">
            <span class="info-box-text">PO Records</span>
            <span class="info-box-number text-right">
                <?php 
                    echo $conn->query("SELECT * FROM `purchase_order_list` WHERE `status` = 'Process'")->num_rows;
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <span class="info-box-number text-right">
                <?php 
                    echo $conn->query("SELECT * FROM `purchase_order_list` WHERE `status` = 'Receive'")->num_rows;
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
