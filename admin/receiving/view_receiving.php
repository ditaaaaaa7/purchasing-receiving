...
<div class="card card-outline card-danger">
    ...
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-danger">FROM P.O. Code</label>
                ...
                <?php if(isset($bo_id)): ?>
                <div class="col-md-6">
                    <label class="control-label text-danger">FROM B.O. Code</label>
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tbody>
                    <?php 
                    $total = 0;
                    $qry = $conn->query("SELECT s.*,i.name FROM `stock_list` s inner join item_list i on s.item_id = i.id where s.id in ({$stock_ids})");
            ...
            <div class="row">
                ...
                <?php if($status > 0): ?>
                <div class="col-md-6">
                    <span class="text-danger"><?php echo ($status == 2)? "RECEIVED" : "PARTIALLY RECEIVED" ?></span>
                </div>
                <?php endif; ?>
            </div>
        </div>
