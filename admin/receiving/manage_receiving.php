...
<div class="card card-outline card-danger">
        ...
        <form action="" id="receive-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php else: ?>
                        <div class="col-md-6">
                        <label class="control-label text-danger">B.O. Code</label>
                ...
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <tbody>
                        ...
                        if(isset($po_id)):
                        if(!isset($bo_id))
                        $qry = $conn->query("SELECT p.*,i.name FROM `po_items` p inner join item_list i on p.item_id = i.id where p.po_id = '{$po_id}'");
                        else
                        $qry = $conn->query("SELECT b.*,i.name FROM `bo_items` b inner join item_list i on b.item_id = i.id where b.bo_id = '{$bo_id}'");
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-danger" type="submit" form="receive-form">Save</button>
