...
<div class="card card-outline card-danger">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-danger btn-md "><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td ><p class="m-0"><?php echo ($row['type'] == 1 )? "Adminstrator" : "Manager" ?></p></td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=user/manage_user&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-dark"></span> Edit</a>
